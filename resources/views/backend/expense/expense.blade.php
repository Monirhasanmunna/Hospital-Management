...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Expense <a href="javascript:void(0)" class="btn btn-primary ml-3" id="AddExpense"><i class="fas fa-plus"></i>Add Expense </a></h1>
      <ol class="breadcrumb">
            ...
            <div class="card mb-4">
              <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <tbody>
                    @foreach (App\Models\Expense\Expense::all() as $key=>$expense)
                    <tr>
                      <td>{{$key+1}}</td>
