...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Refferal Payment</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('app.dashboard')}}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Refferal Payment</li>
      </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
...
<!-- Large modal -->
<div class="modal fade bd-example-modal-lg" id="RefferalPaymentModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
              <div class="card-header pt-3 pb-2 d-flex flex-row align-items-center justify-content-between bg-primary">
                <h6 class="m-0 font-weight-bold text-white">Refferal Payment</h6>
...
@push('js')
    <script>
        function ReferelPayment(id){
            ...
            $('#RefferalPaymentModel').modal('show');
        }
        ...
        function payment(){
          ...
          $.ajax({
            type: "POST",
            url: "{{ route('app.refferal_payment') }}",
            data: data,
            dataType: "json",
            success: function (response) {
              $('#RefferalPaymentModel').modal('hide');
              console.log(response);
              // window.open("/app/finance/refferal/payment/invoice/"+response.id+"/"+response.paid,"popup",properties);
              location.reload();
