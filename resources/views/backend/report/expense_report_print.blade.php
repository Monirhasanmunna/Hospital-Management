            ...
            <div class="tm_round_border">
              <div class="tm_table_responsive">
                <table class="table">
                  <thead>
                    <tr>
                      <th class="tm_semi_bold tm_primary_color">Date</th>
                      <th class="tm_semi_bold tm_primary_color">Expense Category</th>
                      <th class="tm_semi_bold tm_primary_color">Details</th>
                      <th class="tm_semi_bold tm_primary_color tm_text_right">Amount</th>
                    </tr>
                  </thead>
                  <tbody>
                    @php
                    ...
                    <tr>
                      ...
                      <td class="">{{ $expense->details }}</td>
                      <td class="tm_text_right">{{$expense->amount}}</td>
                    </tr>
                    @php
                  ...
                  <tfoot style="border-top:1px solid #ddd">
                    <tr>
                      ...
                      <th class="tm_text_right">{{ $total }}/-</th>
                    </tr>
                  </tfoot>
                </table>
              </div>
