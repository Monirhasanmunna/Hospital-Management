            ...
            <div class="card">
                <div class="card-header m-auto">
                    <form class="form-inline">
                        ...
                        <a href="{{ route('app.report.collectionIndex') }}" class="btn btn-primary ml-5">Today</a> 
                    </form>
                </div>
            </div>
            <div class="card mb-4">
              ...
              <div class="day_show m-auto pt-3">
                @if ($income)
                <p>Report Form {{$income['from_date']}} To {{$income['to_date']}}</p>
                @endif
              </div>
    ...
    <script>
        function PrintReport(){
            ...
            if (from_date && to_date) {
              window.open("/app/report/collection_report_print/"+from_date+"/"+to_date,"popup",properties);
            }else{
        ...
        function showReport(){
          ...
          const to_date = $('#to_date').val();
          if (from_date && to_date) {
              window.open("/app/report/collectio_report/"+from_date+"/"+to_date,"_self");
            }else{
                alert('Plz selecet the date');
            }
        }
