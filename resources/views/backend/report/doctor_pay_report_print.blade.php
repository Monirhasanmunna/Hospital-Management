            ...
            <div class="tm_round_border">
              <div class="tm_table_responsive">
                <table class="table">
                  <thead>
                    <tr>
                      <th class="tm_semi_bold tm_primary_color">Doctor's Name</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="">{{$refferpay->patinet->doctor->name}}</td>
                      ...
                      <td class="">{{$refferpay->doctor_paid}}</td>
                    </tr>
                    @php
                      $total += $refferpay->refd_amount;
                      $paid += $refferpay->doctor_paid;
                    @endphp
                    @endforeach
                  </tbody>
