...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Discount Report</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('app.dashboard')}}">Home</a></li>
        <li class="breadcrumb-item">Today's Discount</li>
      </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
    ...
    <script>
        function PrintReport(){
            ...
            if (from_date && to_date) {
              window.open("/app/report/discount_report_print/"+from_date+"/"+to_date,"popup",properties);
            }else{
        ...
        function showReport(){
          ...
          const to_date = $('#to_date').val();
          if (from_date && to_date) {
              window.open("/app/report/discount/"+from_date+"/"+to_date,"_self");
            }else{
                alert('Plz selecet the date');
            }
        }
