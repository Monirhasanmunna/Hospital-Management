...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Today's Income</li>
      </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header m-auto">
                    <form class="form-inline">
                        ...
                        <a href="{{ route('app.report.income') }}" class="btn btn-primary ml-5">Today</a> 
                    </form>
                </div>
            </div>
            <div class="card mb-4">
    ...
    <script>
        function PrintReport(){
            ...
            if (from_date && to_date) {
              window.open("/app/report/income_report_print/"+from_date+"/"+to_date,"popup",properties);
            }else{
        ...
        function showReport(){
          ...
          const to_date = $('#to_date').val();
          if (from_date && to_date) {
              window.open("/app/report/income/"+from_date+"/"+to_date,"_self");
            }else{
                alert('Plz selecet the date');
            }
        }
